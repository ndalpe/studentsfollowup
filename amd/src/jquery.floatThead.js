...
// (function( $ ) {
  ...
  $.fn.floatThead = function(map){
    ...
    this.filter(':not(.'+opts.floatTableClass+')').each(function(){
      ...
      // on IE using absolute positioning doesn't look good with window scrolling, so we change position to fixed on scroll,
      // and then change it back to absolute when done.
